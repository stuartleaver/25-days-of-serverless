...
A webhook on a GitHub repository which calls an **Azure Function** which in turn saves URL's for any PNG files in the commit or push to a **Serverless Azure SQL Database**.

Just push PNG files to https://github.com/stuartleaver/azure-test-repo

If you test locally, you will need to set the correct connection string in the settings file. Also, if you deploy the function, you will need to add the connection string to the Application Settings in the Function resource.

**The Webhook (Push is selected further down)**
![The Webhook](images/webhook-settings.png)

**The Commit (Got to like cat pictures!!!!!)**
![The Commit](images/commit.png)

**The Serverless Azure SQL Database Results**
![The Serverless Azure SQL Database Results](images/results.png)
